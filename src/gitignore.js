...
chaussures.filter(function(chaussure){
  ...
  console.log("Le prix : " + chaussure.prix + " et Modèle : " + chaussure.titre)
})
...
chaussures.filter(function(chaussure){
  ...
  console.log("Collector : " + chaussure.collector + " et Modèle : " + chaussure.titre)
})
